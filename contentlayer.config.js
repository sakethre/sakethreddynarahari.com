	...
	structuredData: {
		...
		resolve: (doc) => ({
			...
			description: doc.summary,
				image: doc.image
					? `https://sakethreddynarahari.com${doc.image}`
					: `https://sakethreddynarahari.com/api/og?title=${doc.title}`,
				url: `https://sakethreddynarahari.com/blog/${doc._raw.flattenedPath}`,
			author: {
				'@type': 'Person',
