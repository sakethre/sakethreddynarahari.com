...
This is my personal website built using NextJs, Tailwind CSS, and Vercel. I'll try to use this website to share my goals, learnings and thoughts. 

Feel free to fork and customize it for your own use. If you find any issues in the website, feel free to open an issue and if you want, you can open a pull request for it too.
